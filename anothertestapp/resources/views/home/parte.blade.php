{{-- Se parte de CKFM --}}
<div class="w-full h-[150vh] unefondo flex justify-center items-center ">
    <div class=" space-y-6 justify-between items-center text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
        <div class="md:4/10 lg:w-1/2 flex justify-end m-0">
          <img class="w-[100%]" src="../resources/img/png/imagen3.png" alt="image" loading="lazy" width="" height="" class="w-full">
        </div>
        <div class=" md:7/12 lg:w-1/2">
          ...
          <div class="flex justify-center w-full ">
            <button class="fade-in bounce-top-icons bg-blue-700 text-white px-5  py-2 rounded-[10px] ">Conocer</button>
          </div>
        </div>
      </div>
</div>
