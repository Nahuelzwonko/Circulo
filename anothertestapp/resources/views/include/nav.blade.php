...
<nav class="glass z-10 lg:py-8 md:pb-0 invisible lg:visible">
    ...
    <div class="flex items-center md:justify-between sm:justify-center h-16 ">
      ...
      <div class="flex items-end invisible lg:visible lg:text-lg md:text-[0.9rem] sm:text-[0.5rem] 2xl:gap-10 xl:gap-6 lg:gap-14 lg:mt-0 md:mt-8">
        ...
        >
          ...
          <span class="text-white transition font-Poppins  hover:text-gray-300">presidencia@kinesiologosmza.com</span>
        </a>
        </div>
        <div class="mr-4 ">
          <a
        ...
        <span class="text-white hover:text-gray-300 font-Poppins">123-456-7890</span>
          ...
          <button class=" flex flex-row items-center gap-2 bg-blue-800 text-white px-3 py-1 pl-1 rounded-lg font-extralight hover:bg-blue-600">
            <svg width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M9.6015 11.2164C9.43276 11.3794 9.4281 11.6486 9.59113 11.8173C9.75416 11.9862 10.0232 11.9908 10.192 11.8278C10.1955 11.8244 10.199 11.8209 10.2025 11.8173L12.7526 9.26728C12.9185 9.10152 12.9186 8.83265 12.7527 8.66664C12.7527 8.66651 12.7526 8.66651 12.7526 8.66638L10.2025 6.11635C10.0337 5.95331 9.76467 5.95798 9.6015 6.12685C9.44249 6.29157 9.44249 6.55266 9.6015 6.71738L11.426 8.54187H2.25205C2.0173 8.54187 1.82703 8.73214 1.82703 8.96689C1.82703 9.20165 2.0173 9.39192 2.25205 9.39192H11.426L9.6015 11.2164Z" fill="white"/>
              </g>
              <defs>
              <clipPath id="clip0_30_76">
              <rect width="17" height="17" fill="white" transform="translate(0.963745 0.5)"/>
              </clipPath>
              </defs>
            </svg>
  ...
  <!-- Menú de navegación -->
  <div class="2xl:max-w-[85%] xl:max-w-[95%]: xl:mx-auto lg:mx-4 border-white-600 border-t-[0.5px] lg:border-none  mt-0 invisible lg:visible h-0 lg:h-auto">
...
<nav class="glass fixed w-screen z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 visible lg:invisible">
  ...
  <div class="items-center justify-between hidden  w-screen" id="navbar-sticky">
    <ul class="flex flex-col p-4 md:p-0 mt-4  border-gray-100 rounded-lg  ">
      <li>
        <a href="#" class="font-Poppins block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Inicio</a>
      </li>
      <li>
        <a href="#" class="font-Poppins block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Quienes Somos</a>
      </li>
      <li>
        <a href="#" class="font-Poppins block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Kine Club</a>
      </li>
      <li>
        <a href="#" class="font-Poppins block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Noticias</a>
      </li>
      <li>
        <a href="#" class="font-Poppins block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Obras Sociales y Prepagas</a>
      </li>
    </ul>
  </div>
