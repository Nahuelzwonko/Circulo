            ...
            <div
                ...
                <div class="mr-4">
                    <a class="flex items-center justify-center sm:justify-start gap-1.5 group" href="/">
                        ...
                        <span
                            class="text-white transition font-Poppins  hover:text-gray-300">presidencia@kinesiologosmza.com</span>
                    </a>
                </div>
                <div class="mr-4 ">
                    <a class="flex items-center justify-center sm:justify-start gap-1.5 group" href="/">
                ...
                <button
                    ...
                    <svg width="20" height="20" viewBox="0 0 18 18" fill="none"
                        ...
                        <g clip-path="url(#clip0_30_76)">
                            <path
                                d="M15.0018 0.466797H9.05177C7.87863 0.468224 6.92806 1.4188 6.92677 2.5918V4.29178C6.92677 4.52654 7.11704 4.71681 7.35179 4.71681C7.58642 4.71681 7.77682 4.52654 7.77682 4.29178V2.5918C7.77747 1.88792 8.34789 1.3175 9.05177 1.31672H15.0018C15.7055 1.3175 16.2759 1.88792 16.2767 2.5918V15.3418C16.2759 16.0456 15.7055 16.616 15.0018 16.6168H9.05177C8.34789 16.616 7.77747 16.0456 7.77669 15.3418V13.6417C7.77669 13.4071 7.58642 13.2168 7.35166 13.2168C7.11691 13.2168 6.92664 13.4071 6.92664 13.6417V15.3418C6.92806 16.5148 7.87863 17.4654 9.05164 17.4668H15.0018C16.1748 17.4654 17.1253 16.5148 17.1268 15.3418V2.5918C17.1253 1.4188 16.1748 0.468224 15.0018 0.466797Z"
                                fill="white" />
                            <path
                                d="M9.6015 11.2164C9.43276 11.3794 9.4281 11.6486 9.59113 11.8173C9.75416 11.9862 10.0232 11.9908 10.192 11.8278C10.1955 11.8244 10.199 11.8209 10.2025 11.8173L12.7526 9.26728C12.9185 9.10152 12.9186 8.83265 12.7527 8.66664C12.7527 8.66651 12.7526 8.66651 12.7526 8.66638L10.2025 6.11635C10.0337 5.95331 9.76467 5.95798 9.6015 6.12685C9.44249 6.29157 9.44249 6.55266 9.6015 6.71738L11.426 8.54187H2.25205C2.0173 8.54187 1.82703 8.73214 1.82703 8.96689C1.82703 9.20165 2.0173 9.39192 2.25205 9.39192H11.426L9.6015 11.2164Z"
                                fill="white" />
                        </g>
                        <defs>
                            <clipPath id="clip0_30_76">
                                <rect width="17" height="17" fill="white"
                                    transform="translate(0.963745 0.5)" />
                            </clipPath>
                        </defs>
                    </svg>
        ...
        <div class="flex lg:justify-end md:justify-center">
            <div id="items"
                ...
                <a href="{{route('kine.index')}}"
                    class="font-Poppins  text-white px-3 py-2 lg:text-lg md:text-[0.9rem] mt-2 hover:underline">Kine
                    Club</a>
                <div class="h-[60%] w-[1px] bg-gray-400 mt-3 invisible lg:visible"></div>
