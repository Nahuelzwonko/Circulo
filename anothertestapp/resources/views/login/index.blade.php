...
<!-- Body le da fondo gradiente de celeste a índigo. -->
<body class="bg-gradient-to-r from-sky-500 to-indigo-500 pb-20 w-screen h-screen">
    <!-- Clase Padre Grid. Para dividir el card en 2. -->
    <div class="  2xl:w-2/3 xl:4/5 lg:w-4/5 lg:w-4/5 lg:grid lg:grid-cols-2 lg:mx-auto lg:mt-20 lg:w-2/3 lg:rounded-xl  lg:shadow-2xl shadow-black max[374px]:w-full">
        ...
        <div class="left flex flex-col gap-10 items-center bg-white rounded-l-xl ">
            ...
            <div class="logo flex flex-row mt-12 gap-4 font-medium">
                <img class="" src="../assents/img/cfkm-logo.svg" alt="logo">
                <p class=""><span class="text-blue-500">C</span>irculo de<br>
            ...
            <img class="rounded-2xl w-full h-2/5 lg:hidden"src="../assents/img/login-bg.svg" alt="">
            <!-- Título -->
            ...
            <form action="" class="flex flex-col w-10/12 gap-8 justify-center mb-10 text-lg">
                ...
                <div class="flex flex-row gap-36 text-base justify-center 2xl:gap-24 xl:gap-8 lg:gap-4">
                ...
                <div class="flex flex-row justify-center gap-10 mb-4 text-base font-medium">
                    <button class="border border-blue-500 rounded-lg py-3 px-12 bg-blue-500 text-white hover:bg-blue-700  2xl:py-3"><a href="/pages/index.php">Iniciar Sesión</a></button>
                    <button class="border border-blue-500 rounded-lg py-3 px-12 text-blue-500  2xl:py-3"><a href="circuloC/pages/register.php">Registrarme</a></button>
                </div>
                
                <span class="flex flex-row gap-8 justify-center 2xl:gap-4 xl:gap-3.5 xl:text-base lg:text-sm lg:gap-4"><span class="font-light">O, Inicia Sesión con</span> <a href="#" class="text-blue-400 hover:underline">Facebook</a> <a href="#" class="text-blue-400 hover:underline">Linked In</a> <a href="#" class="text-blue-400 hover:underline">Google</a></span>
            </form>
        </div>
        <!-- Div 2, Segundo hijo. Contiene la imagen de la derecha. -->
        <div class="right h-full invisible lg:visible">
            <img class="rounded-r-xl h-full w-full" src="../assents/img/login-bg.svg" alt="">
        </div>        
    </div>
