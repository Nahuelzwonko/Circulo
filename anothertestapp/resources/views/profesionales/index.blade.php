    ...
    <section class="h-[100vh] flex flex-col items-center mt-20">
        ...
        <div class="w-[80%] relative overflow-x-auto  sm:rounded-lg">
            <div class="flex items-center mb-4">
                ...
                <label for="default-checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Atencion
                    Domi</label>
            </div>
            {{--  --}}
            ...
            <table class="w-full text-left text-gray-500 dark:text-gray-400 text-lg">
                <thead
                    ...
                    <tr class="">
                        ...
                        <th scope="col" class="px-6 py-4">
                            <i class="fa-solid fa-tag fa-flip-horizontal mr-2"></i>Localidad
                        </th>
                        <th scope="col" class="px-6 py-4">
