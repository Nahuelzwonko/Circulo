        ...
        <div class="left flex flex-col gap-10 items-center bg-white rounded-l-xl ">
            ...
            <form action="POST" class="flex flex-col w-10/12 gap-8 justify-center mb-10 text-lg max[374px]:w-fit">
                ...
                <div class="flex flex-row justify-center gap-10 mb-4 text-base font-medium">
                    <button class="border border-blue-500 rounded-lg py-3 px-12 bg-blue-500 text-white hover:bg-blue-700  2xl:py-3"><a href="/pages/index.php">Registrarme</a></button>
                    <button class="border border-blue-500 rounded-lg py-3 px-12 text-blue-500  2xl:py-3"><a href="/pages/login.php">Iniciar Sesión</a></button>
                </div>
