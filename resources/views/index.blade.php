...
<div id="bottom-banner" tabindex="-1" class="fixed bottom-0 start-0 z-50 flex justify-between w-full p-4  bg-blue-600 ">
    <div class="flex items-center mx-auto">
        <p class="flex items-center text-sm font-normal text-white">
            ...
            <span>¿Ya conoces nuestros descuentos y becas para cursos y capacitaciones?.<a href="{{ route('sorteo.index') }}" class="flex items-center ms-0 text-sm font-medium text-white md:ms-1 md:inline-flex hover:underline">CONOCER<svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
