...
@section('content')
    ...
    <div class="swiper my-6 md:my-10 lg:mt-16 lg:mb-24">
        <div class="swiper-wrapper flex">
            <div class="swiper-slide lg:my-6 md:my-10 flex flex-row justify-around lg:gap-24">
                ...
                <img src="{{ asset('storage/clients/logo-swiss.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-dasuten.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-SCIS.svg') }}" alt="client logo" class=" sm:w-1/5 " width="100px">

            </div>
            <div class="swiper-slide lg:my-6 md:my-10 flex flex-row justify-around lg:gap-24 ">
                <img src="{{ asset('storage/clients/logo-amffa.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-damsu.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-elevar.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-hope.svg') }}" alt="client logo" class=" sm:w-1/5 " width="100px">

            </div>
            <div class="swiper-slide lg:my-6 md:my-10 flex flex-row justify-around lg:gap-24">
                <img src="{{ asset('storage/clients/logo-jerarquicos.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-opdea.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-OSADEF.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-OSDIPP.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">

            </div>
            <div class="swiper-slide lg:my-6 md:my-10 flex flex-row justify-around lg:gap-24">
                <img src="{{ asset('storage/clients/logo-osjera.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-OSPJN.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-OSPPRE.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-OSSEG.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">

            </div>
            <div class="swiper-slide lg:my-6 md:my-10 flex flex-row justify-around lg:gap-24">
                <img src="{{ asset('storage/clients/logo-prevencion.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-rural.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-sadaic.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-sancor.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">

            </div>
            <div class="swiper-slide lg:my-6 md:my-10 flex flex-row justify-around lg:gap-24">
                <img src="{{ asset('storage/clients/logo-union.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-medicus.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
                <img src="{{ asset('storage/clients/logo-IOSFA.svg') }}" alt="client logo" class=" sm:w-1/5"
                    width="100px">
                <img src="{{ asset('storage/clients/logo-pasteur.svg') }}" alt="client logo" class=" sm:w-1/5 "
                    width="100px">
        ...
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <div class="flex justify-center w-full">
                    <button
                        class=" font-Poppins invisible lg:visible text-sm  bg-[#0051A7] hover:bg-blue-700 text-white px-5  py-2 rounded-[10px] "><a
    ...
    {{-- <div
        ...
        <div class=" md:7/12 lg:w-1/2">
            ...
            <div class="flex justify-center w-full ">
                <button
                    class="invisible lg:visible fade-in bounce-top-icons bg-[#0051A7] hover:bg-blue-500 text-white px-5  py-2 rounded-[10px] font-Poppins "><a
                        href="../quienes/index.blade.php">Quiero ser parte</a></button>
            </div>
        </div>
    ...
    <div class="hidden lg:flex lg:visible w-full h-[150vh]  justify-center items-center ">
        <div
            ...
            <div class="md:4/10 lg:w-1/2 flex justify-end m-0">
                <img class="w-[80%] " src="{{ asset('storage/png/imagen3.svg') }}" alt="image" loading="lazy"
            ...
            <div class=" md:7/12 lg:w-1/2">
                ...
                <div class="flex justify-center w-full ">
                    <button
                        class="fade-in bounce-top-icons bg-[#0051A7] hover:bg-blue-500 text-white px-5  py-2 rounded-[10px] "><a
