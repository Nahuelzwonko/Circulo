                                    ...
                                    <div class="flex justify-center items-center">
                                        <form action="{{ route('formulario.destroy', $formulario->id) }}" method="post">
                                            ...
                                            <button type="submit"
                                                ...
                                                class="text-white  bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Eliminar
                                            </button>
                                        </form>
                                    </div>
                                </td>
