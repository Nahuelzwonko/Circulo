                    ...
                    <tbody>
                        @foreach ($formularios as $formulario)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="w-full flex flex-col justify-center  align-top">
                                        ...
                                        <form action="{{ route('formulario.destroy', $formulario->id) }}" method="post">
                                            ...
                                            <button type="submit"
                                                ...
                                                class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Eliminar
                                            </button>
                                        </form>
                                    </div>
                                ...
                                <td>
                                    @foreach ($formularios as $formulario)
                                        ...
                                        <a href="{{ route('formulario.pdf', $formulario->id) }}"
                                            class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">Descargar PDF</a>
                                    @endforeach
                                </td>
                            </tr>
                        @endforeach
