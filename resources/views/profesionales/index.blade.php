...
@section('cont', 'Aquí encontraras a cada uno de los profesionales asociados. Te invitamos a utilizar los filtros para
                ...
                <div class="flex flex-col lg:flex-row-reverse justify-evenly items-center px-8 mt-8 lg:py-20">
                    <div class="flex items-center mb-4">
                        ...
                        <label for="default-checkbox"
                            class="ml-2 text-lg font-medium text-gray-900 dark:text-gray-300 ">Atención Domiciliaria</label>
                    </div>
                    {{--  --}}
