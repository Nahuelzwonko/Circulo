...
@section('content')
    ...
    <section class="text-gray-600 body-font bg-dash-bg-resp bg-contain lg:bg-dash-bg lg:bg-contain bg-repeat-y">
        <div class="w-full flex justify-between bg-dash-head-resp bg-contain bg-no-repeat lg:bg-dash-head lg:bg-cover lg:h-[400px] lg:bg-no-repeat">
            <h1 class="text-2xl md:text-6xl uppercase title-font text-[#5068E1] entrance lg:self-center ml-8 mt-14 lg:ml-36 lg:mt-32 tracking-[0.5rem">Bienvenido <br><span class="font-bold pl-10lg:text-7xl">{{ $username }}</span> </h1>
            <img src="{{ asset('storage/logo/logowhite.svg') }}" class="w-[25%] h-[40%] lg:h-auto lg:w-[15%] mr-8 mt-3 lg:mt-20 lg:mr-28" alt="">
        ...
        <div class="container lg:px-5 lg:py-24 mx-auto mt-16 lg:mt-20">
            <div class="flex flex-col justify-start text-center w-full mb-12">
                ...
                <p class="text-2xl lg:text-5xl text-slate-800 font-medium mb-10 leading-normal mx-auto lg:w-[95%] font-hammersmith">¡Bienvenido(a) al nuevo sistema web del Círculo de Kinesiólogos y Fisioterapeutas de Mendoza!</p>
                <p class="lg:w-[80%] mx-auto leading-loose lg:text-3xl font-monserrat"> Aquí encontrarás herramientas y recursos para mejorar tu
        ...
        <div class="container lg:px-5 mt-8 lg:py-24 mx-auto">
            <div class="text-center mb-10 lg:mb-48">
                <h1 class="text-2xl lg:text-5xl lg:w-[75%] mx-auto font-hammersmith title-font text-gray-900 mb-10">Herramientas y recursos
                    diseñados para facilitar tu experiencia</h1>
                <p class="text-base lg:text-3xl font-monserrat leading-relaxed lg:w-[70%] mx-auto text-gray-500 mb-8">Te brindamos
                    un entorno <span class="font-medium text-indigo-500 lg:text-3xl">digital, moderno <span class="text-gray-500 lg:text-2xl font-normal">y </span> accesible</span>, donde puedas acceder a información relevante, participar en eventos y
            ...
            <div class="grid grid-cols-1 mx-auto content-center items-center lg:gap-40">
                ...
                <div class="p-4 w-[80%] mx-auto flex flex-col text-center items-center">
                    <h2 class="text-gray-900 text-3xl lg:text-7xl py-4 my-4 title-font font-bold font-hammersmith mb-8 focus-in-expand from-slate-200 via-sky-500 to-slate-800 bg-gradient-to-r bg-clip-text text-transparent">KineClub Digital</h2>
                    <a href="{{ route('tarjeta') }}">
                        ...
                        <div class="flex-grow">
                            ...
                            <ul class="flex flex-col gap-4 list-disc leading-relaxed lg:text-3xl font-monserrat text-justify">
                                <li>Tu KineClub ahora es digital!</li>
                                <li>Disfrutá de una experiencia única y aprovechá al máximo tu membresía en el Círculo de Kinesiólogos y Fisioterapeutas de Mendoza.</li>
                ...
                <div class="p-4 w-[80%] mx-auto flex flex-col text-center items-center">
                    <h2 class="text-gray-900 text-3xl lg:text-7xl py-4 my-4 font-hammersmith title-font font-bold mb-8 focus-in-expand from-slate-200 via-sky-500 to-slate-800 bg-gradient-to-l bg-clip-text text-transparent">Consultorio Virtual</h2>
                    <a href="{{ route('consultorio') }}">
                        ...
                        <div class="flex-grow">
                            ...
                            <ul class="flex flex-col gap-4 list-disc leading-relaxed lg:text-3xl font-monserrat text-justify">
                                <li>Atiende y da terapia a tus pacientes de forma remota, desde la comodidad de tu propio espacio.</li>
                                <li>Realiza consultas y sesiones de rehabilitación en línea, brindando seguimiento efectivo a tus pacientes.</li>
                ...
                <div class="p-4 w-[80%] mx-auto flex flex-col text-center items-center">
                    <h2 class="text-gray-900 text-3xl lg:text-7xl py-4 my-4 title-font font-hammersmith font-bold mb-8 focus-in-expand from-slate-200 via-sky-500 to-slate-800 bg-gradient-to-br bg-clip-text text-transparent">Agenda Virtual</h2>
        ...
        <div class="container lg:px-5 py-24 mx-auto">
            <div class="xl:w-[70%] lg:w-3/4 w-full mx-auto text-center">
                ...
                <p class="leading-relaxed lg:text-2xl font-monserrat">Te invitamos a explorar y descubrir todas las funcionalidades que este
